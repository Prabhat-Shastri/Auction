...
function Tops() {
  ...
  const fetchItems = async () => {
    try {
      const response = await api.get('/api/tops')
                ...
                <div key={item.id} className={`item-card ${auctionClosed ? 'auction-closed' : ''}`}>
                  ...
                  <div className="item-body">
                    ...
                    <div className="measurements">
                      ...
                      <p>Front: {item.frontLength}cm | Chest: {item.chestLength}cm | Sleeve: {item.sleeveLength}cm</p>
                    </div>
                  ...
                  <div className="item-footer">
                    ...
                    <button
                      ...
                      onClick={() => navigate(`/bid-history?itemType=top&itemId=${item.id}`)}
                    >
                      Bid History
                    </button>
                  </div>
        ...
        {selectedItem && (
          <div className="bid-modal-overlay" onClick={() => setSelectedItem(null)}>
            <div className="bid-modal" onClick={(e) => e.stopPropagation()}>
              ...
              <h2>Place Bid on {selectedItem.description || `Top #${selectedItem.id}`}</h2>
