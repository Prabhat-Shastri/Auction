...
if(gender != null) {
    ...
    if(minimum != null && !minimum.isEmpty() && !minimum.equals("0.0")) {
        String insertBottomInformation = "insert into bottoms (auctionSellerIdValue, genderValue, sizeValue, colorValue, waistLengthValue, inseamLengthValue, outseamLengthValue, hipLengthValue, riseLengthValue, descriptionValue, conditionValue, minimumBidPriceValue, auctionCloseDateValue, auctionCloseTimeValue) values ('" + userIdValue + "','" + gender + "' ,'" + size + "' ,'" + color + "','" + waistlength + "','" + inseamlength + "','" + outseamlength + "','" + hiplength + "','" + riselength + "', '" + description + "', '" + condition + "', '" + minimum + "', '" + auctionclosedate + "', '" + auctionclosetime + "')"; 
...
while(rs.next()) {  
    ...
    out.println("<p>Color: " + waistLengthValueDisplay + "</p>");
    out.println("<p>Color: " + inseamLengthValueDisplay + "</p>");
    out.println("<p>Color: " + outseamLengthValueDisplay + "</p>");
    out.println("<p>Color: " + hipLengthValueDisplay + "</p>");
    out.println("<p>Color: " + riseLengthValueDisplay + "</p>");
