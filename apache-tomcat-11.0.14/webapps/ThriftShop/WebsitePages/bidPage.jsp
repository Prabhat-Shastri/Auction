...
Integer topIdValue = Integer.parseInt(request.getParameter("topIdValue"));
if(topIdValue > 0) {
    ...
    String returnCurrentBidPrice = "select startingOrCurrentBidPriceValue from tops where topIdValue = '" + topIdValue + "'";
    ...
    if(currentBidPrice.next()) {
        ...
        if(setnewbid > currentBidPriceValue) {
            String insertPlaceBidInformation = "insert into topsIncrementBids (topIdValue, buyerIdValue, newBidValue, bidIncrementValue, bidMaxValue) values ('" + topIdValue + "','" + userIdValue + "' ,'" + setnewbid + "' ,'" + setautomaticbidincrementprice + "','" + maxbidprice + "')"; 
            int insertedRows = st.executeUpdate(insertPlaceBidInformation);
            String insertUpdatedBidInformation = "update tops set startingOrCurrentBidPriceValue = '" + setnewbid + "' where topIdValue = '" + topIdValue + "'";
