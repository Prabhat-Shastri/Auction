 ...
 * Generated at: 2025-12-05 20:31:50 UTC
...
for(int i = 0; i < topIdValueOfItemsBiddedOnByBidder.size(); i++) {
    ...
    if(buyersBidPriceValue != null && currentBidPriceValue != null && buyersBidPriceValue < currentBidPriceValue) {
      ...
      out.write("\n");
      out.write("\n");
      out.write("//add the logic for when the value of the bid increases and then we want to automatically update the bid value and then if the bid value added exceed the current price then we want to ask the user do they want to bid extra which will surpass the bid or do we want to just keep the current bid and add the remaining amount to reach the max");
